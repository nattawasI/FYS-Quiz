    ...
    <>
      <Content bgColor="blue">
        <div className="scene-panel scene-panel--items-center video-doctor" style={{ marginTop: `${marginTop}px`}}>
          ...
          <motion.div className="video-doctor__video video-wrap"
            variants={videoVariant}
            initial="hidden"
            animate="show"
          >
            <div className="video-box">
              <iframe width="560" height="315" src="https://www.youtube.com/embed/GSIR5Le8W4U" title="For Your Sweetheart ฆาตกรบนโต๊ะอาหาร" frameBorder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowFullScreen></iframe>
            </div>
          </motion.div>
        </div>
      </Content>
